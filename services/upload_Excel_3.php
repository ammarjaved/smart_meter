...
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;
   ...
   if (move_uploaded_file($after_tempname, $folder2)) {
        ...
        if( $sheet->getCell('A1')->getValue() == '3MS SO No.' && $sheet->getCell('B1')->getValue() == 'Contract Account' && $sheet->getCell('E1')->getValue() == 'BCRM Status' && $sheet->getCell('F1')->getValue() == 'User Status' && $sheet->getCell('P1')->getValue() == 'New Meter no'){
